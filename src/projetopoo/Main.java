...
public class Main {
    ...
    private static void excecaoInteirosNegativos(int numeroEntrada) {
    ...
    private static void execcaoPorcentagemPromocional(double numeroEntrada) {
    ...
    private static void excecaoDoubles(double numeroEntrada) {
